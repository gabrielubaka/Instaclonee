                  ...
                  <div className="aspect-square group relative">
                    {item.endsWith(".mp4") || item.endsWith(".webm") ? (
                      <>
                        ...
                        />
                        <button onClick={handlePlayPause} className="absolute top-1/2 left-[45%] btn btn-circle btn-ghost hover:bg-transparent opacity-75 hover:opacity-100 text-white border-0">
                        {isPlaying ? 
